...
🎓 תהליך הלמידה והערות
המדריך שנכתב כאן הוא סיכום של התנסות מעשית (Hands-on) במעבדות תקיפה, בשילוב מחקר והעמקה בתכנים מקצועיים מהקהילה. המטרה של התיעוד היא להנגיש את המושגים המורכבים של עולם ה-Shells בעברית, תוך התבססות על מתודולוגיות עבודה מקובלות ושימוש במקורות מידע מובילים בתחום ה-Cyber Security.

📚 מקורות והשראה (Resources & Credits)
המדריך הזה נבנה תוך הסתמכות על מקורות מעולים שעזרו לי להבין את הנושא לעומק. אם אתם רוצים להרחיב את הידע, אני ממליץ בחום לעיין בהם:

מדריך וידאו: Shells Walkthrough – סרטון מצוין שמדגים בצורה ויזואלית את כל שלבי העבודה עם המכונות.

Shells Overview (Medium) – מאמר מפורט מאת Isiah Johnstone שסוקר את המושגים התיאורטיים והמעשיים של סוגי ה-Shells השונים.

TryHackMe - Shells Room – חדר הלימוד המקורי שעליו מבוסס התרגול המעשי.
